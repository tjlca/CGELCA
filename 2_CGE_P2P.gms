...
Positive Variable
p_F1_1    Price of VC scale product F1(Conventional($|kg)
p_F1_2    Price of VC Scale product F1(Clean)($|kg);
...
Link1.. p_F1_1 =E= pq('PR1')*2.8+pq('PR2')*1.5;
...
final_demand1.. demand_to_PR1 =E= Xp('PR1') - Xp0('PR1');
